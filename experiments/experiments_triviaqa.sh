...
# Usage:
#   uv run bash experiments_triviaqa.sh <MODEL> [LAYER_IDX] [REPEAT] [T]
#
# Example:
#   uv run bash experiments_triviaqa.sh Llama3.1-8B-Base 13 3 1.0
...
for ((i=0; i<REPEAT; i++)); do
  ...
  uv run python -u scripts/triviaqa/triviaqa_eval.py \
